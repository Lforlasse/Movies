  ...
  @Test
    public void testFindByTitle() {
      given()
                ...
                then().assertThat().body("title", hasItems("Harry Potter and the Philosopher's Stone"));
        //TODO
    }
    ...
    public void testFindById() {
        given().get("/movie/"+ m2.getId()).then().assertThat().body("id", equalTo(m2.getId()));
