...
//     @Path("/MoviesByActor/{actor}")
//    @GET
//    @Produces({MediaType.APPLICATION_JSON})
//     public Response getByActor(@PathParam("actor") String actor) {
//        return Response.ok().entity(GSON.toJson(FACADE.getMoviesByActors(actor))).build();
//    }
